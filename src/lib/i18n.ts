...
export const translations = {
  en: {
    siteName: {
      ...
      geo: 'GEO / AEO Reviewer',
    },
    heroTitle: 'Scan any page for accessibility, SEO, performance, GEO or AEO issues',
    heroSubtitle:
    ...
    viewHtmlReport: 'View a preview of the detailed report',
    ...
    manualTimeLabel: 'Estimated manual dev time (for one scanned page)',
  ...
  fr: {
    ...
    heroTitle: "Analysez n'importe quelle page pour l'accessibilité, le SEO, la performance, le GEO ou l'AEO",
    heroSubtitle:
    ...
    viewHtmlReport: 'Voir un aperçu du rapport détaillé',
    ...
    manualTimeLabel: 'Temps de développement manuel estimé (pour une page analysée)',
